...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "caminho/para/seu/arquivo.json"  # Substitua pelo caminho do seu arquivo JSON
...
def tabela_geral(df):
    ...
    table_id = "seu-projeto.seu-dataset.tabela_geral"  # Substitua pelo seu projeto e dataset
...
def gerar_tabela_grupo_peso(df):
    ...
    # Enviar para o BigQuery
    table_id = "seu-projeto.seu-dataset.tabela_peso"  # Substitua pelo seu projeto e dataset
...
def gerar_tabela_group_altura(df):
    ...
    # Enviar para o BigQuery
    table_id = "seu-projeto.seu-dataset.tabela_altura"  # Substitua pelo seu projeto e dataset
...
def tabelas_usando_union(df):
    ...
    # Enviar para o BigQuery
    table_id = "seu-projeto.seu-dataset.tabela_americas"  # Substitua pelo seu projeto e dataset
...
def tabela_usando_joins(df):
    ...
    # Enviar para o BigQuery
    table_id_simples = "seu-projeto.seu-dataset.tabela_join_simples"
    table_id_inner = "seu-projeto.seu-dataset.tabela_inner_join"
    table_id_left = "seu-projeto.seu-dataset.tabela_left_join"
    table_id_right = "seu-projeto.seu-dataset.tabela_right_join"
    table_id_full = "seu-projeto.seu-dataset.tabela_full_join"
    table_id_anti = "seu-projeto.seu-dataset.tabela_anti_join"
